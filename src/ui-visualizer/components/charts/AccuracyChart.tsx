...
export function AccuracyChart({ data, humanBaseline }: AccuracyChartProps) {
  ...
  const chartData: ChartRow[] = [
    {
      ...
      human: humanBaseline.accuracy * 100,
    },
  ]
  ...
  for (const model of data) {
    ...
    for (const fmt of model.formats) {
      row[fmt.format] = fmt.accuracy * 100
    }
    chartData.push(row)
  }
